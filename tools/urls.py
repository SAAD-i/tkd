...
urlpatterns = [
    ...
    path('getusage/<str:id>', ToolUsageView.as_view(),name='get_usage_view'),
    path('postusage/', ToolUsageView.as_view(),name='post_usage_view'),
    path('deleteusage/<str:id>', ToolUsageView.as_view(),name='delete_usage_view'),
    path('getallusage/', ToolUsageView.as_view(),name='get_all_usage_view'),
    path('getcategory/<str:id>', ToolCategoryView.as_view(),name='get_category_view'),
    path('postcategory/', ToolCategoryView.as_view(),name='post_category_view'),
    path('deletecategory/<str:id>', ToolCategoryView.as_view(),name='delete_category_view'),
    path('updatecategory/<str:id>', ToolCategoryView.as_view(),name='update_category_view'),
    path('getallcategories/', ToolCategoryView.as_view(),name='get_all_categories_view'),
    
    
    # path('image_to_text/',view_name,name=view_name),
